...
"border-radius:7px;"));
        ...
        sendLineEdit->setGeometry(QRect(50, 423, 541, 41));
...
"border-radius:10px;"));
        ...
        sendButton->setGeometry(QRect(620, 420, 80, 41));
        sendButton->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);\n"
"border-color: rgb(255, 255, 255);\n"
"border-radius:10px;"));
        messageList = new QListWidget(tab_4);
        messageList->setObjectName("messageList");
        messageList->setGeometry(QRect(50, 31, 541, 361));
        scrollArea = new QScrollArea(tab_4);
        scrollArea->setObjectName("scrollArea");
        scrollArea->setGeometry(QRect(50, 30, 541, 361));
...
"font: 10pt \"Segoe UI\";"));
    ...
    void retranslateUi(QWidget *taskdialog)
    {
        ...
        sendLineEdit->setText(QCoreApplication::translate("taskdialog", "Send your message here", nullptr));
